...
| Doc | Purpose |
|---|---|
| [Development](./development.md) | **Keep web + API up** — `pnpm dev`, restarts, port conflicts, env reload |
...
| [Admin](./admin.md) | Ops dashboard: ingest jobs, listing debug, sponsors, outbound reports |

Product overview and quick start live in the root [README](../README.md).
