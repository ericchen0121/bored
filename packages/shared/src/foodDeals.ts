...
/** Los Angeles — editorial happy hours / lunch deals */
export const CURATED_FOOD_DEALS_LA: CuratedFoodDeal[] = [
  {
    id: "republique-hh",
    venueName: "République",
    title: "République — bar happy hour",
    dealSummary: "Pastries, wine, and bites at the bar",
    description:
      "DTLA institution — weekday bar HH for pastries, oysters, and wine without the full dinner reservation.",
    dealKind: "happy_hour",
    schedule: {
      weekdays: MON_FRI,
      startHour: 15,
    ...
    lng: -118.344,
    city: "la",
    url: "https://www.theinfatuation.com/los-angeles/reviews/republique",
    sources: ["infatuation", "eater_la"],
    rating: 8.7,
    priceMax: 18,
  },
  {
    id: "bestia-hh",
    venueName: "Bestia",
    title: "Bestia — bar happy hour",
    dealSummary: "Cocktails and small plates at the bar",
    description:
      "Arts District favorite — earlier bar seats for pasta-adjacent snacks and drinks without the full wait.",
    dealKind: "happy_hour",
    schedule: {
      weekdays: TUE_FRI,
      startHour: 16,
  ...
  },
  {
    id: "guisados-lunch",
    venueName: "Guisados",
    title: "Guisados — taco lunch",
    dealSummary: "Braised-meat tacos and aguas frescas",
    description:
      "Boyle Heights-born taco shop — lunch lines move fast; grab a sampler plate if you can't choose.",
    dealKind: "lunch",
    schedule: {
      weekdays: DAILY,
      startHour: 11,
    ...
    address: "1261 E Sunset Blvd, Los Angeles",
    lat: 34.0776,
    lng: -118.2436,
    city: "la",
    url: "https://www.theinfatuation.com/los-angeles/reviews/guisados",
    sources: ["infatuation", "eater_la"],
    rating: 8.5,
    priceMax: 12,
  },
  {
    id: "jon-vin-hh",
    venueName: "Jon & Vinny's",
    title: "Jon & Vinny's — happy hour",
    dealSummary: "Pizza, spritzes, and Italian bar snacks",
    description:
      "Fairfax pizza institution — HH at the bar for spicy fusilli-adjacent bites and wine.",
    dealKind: "happy_hour",
    schedule: {
      weekdays: MON_THU,
      startHour: 16,
    ...
    address: "412 N Fairfax Ave, Los Angeles",
    lat: 34.0789,
    lng: -118.3616,
    city: "la",
    url: "https://www.theinfatuation.com/los-angeles/reviews/jon-and-vinnys-fairfax",
    sources: ["infatuation", "eater_la"],
    rating: 8.6,
    priceMax: 16,
  },
  {
    ...
    title: "Grand Central Market — lunch crawl",
    dealSummary: "Dozens of counters — tacos, egg sandwiches, Thai",
    description:
      "DTLA food hall lunch crawl — start at Eggslut or Tacos Tumbras a Tomas and wander the stalls.",
    dealKind: "lunch",
    schedule: {
      weekdays: DAILY,
      startHour: 11,
    ...
    lng: -118.249,
    city: "la",
    url: "https://www.grandcentralmarket.com/",
    sources: ["eater_la"],
    priceMax: 18,
  },
  {
    id: "redbird-hh",
    venueName: "Redbird",
    title: "Redbird — happy hour",
    dealSummary: "Cocktails and share plates in DTLA",
    description:
      "Cathedral-adjacent dining room — bar HH for creative cocktails and snacks under the vaulted ceiling.",
    dealKind: "happy_hour",
    schedule: {
      weekdays: MON_FRI,
      startHour: 17,
    ...
    lng: -118.2442,
    city: "la",
    url: "https://www.theinfatuation.com/los-angeles/reviews/redbird",
    sources: ["infatuation"],
    rating: 8.4,
    priceMax: 18,
  },
  {
    id: "sunny-spot-hh",
    venueName: "Sunny Spot",
    title: "Sunny Spot — happy hour",
    dealSummary: "Island cocktails and Venice-adjacent bites",
    description:
      "Venice-adjacent Caribbean spot — patio HH for rum drinks and jerk-adjacent snacks.",
    dealKind: "happy_hour",
    schedule: {
      weekdays: MON_FRI,
      startHour: 16,
    ...
    neighborhood: "Venice",
    address: "8221 W 3rd St, Los Angeles",
    lat: 34.0724,
    lng: -118.3865,
    city: "la",
    url: "https://www.theinfatuation.com/los-angeles/reviews/sunny-spot",
    sources: ["infatuation", "eater_la"],
    rating: 8.2,
    priceMax: 14,
  },
  {
    id: "mariscos-jalisco",
    venueName: "Mariscos Jalisco",
    title: "Mariscos Jalisco — lunch tacos",
    dealSummary: "Crispy shrimp tacos from the truck",
    description:
      "Boyle Heights truck legend — lunch crispy shrimp tacos and aguachile; cash-friendly.",
    dealKind: "lunch",
    schedule: {
      weekdays: DAILY,
      startHour: 10,
    ...
    address: "3040 E Olympic Blvd, Los Angeles",
    lat: 34.0242,
    lng: -118.2105,
    city: "la",
    url: "https://www.theinfatuation.com/los-angeles/reviews/mariscos-jalisco",
    sources: ["infatuation", "eater_la"],
    rating: 8.8,
    priceMax: 10,
  },
